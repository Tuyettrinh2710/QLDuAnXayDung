...
namespace QLDAXayDung.Controllers
{
    public class NhaCungCapController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaNCC,TenNCC,DiaChi,SDT,SoFax,Email")] NhaCungCap nhaCungCap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNCC,TenNCC,DiaChi,SDT,SoFax,Email")] NhaCungCap nhaCungCap)
        {
            if (ModelState.IsValid)
            {
